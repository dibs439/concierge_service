...
if($_SERVER['HTTP_HOST'] == "localhost")
{
	...
	// localhost »concierge_service »refills
	$project_vars['mysql_db_name'] = "concierge_service";
	$project_vars['mysql_db_user'] = "root";
...
{
	$project_vars['mysql_db_name'] = "prologic_concierge_service";
	$project_vars['mysql_db_user'] = "prologic_concier";
	$project_vars['mysql_db_pass'] = "kI6#Zo9-C=6T";
	$project_vars['mysql_db_host'] = "localhost";
