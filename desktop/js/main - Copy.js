	$(document).ready(function(){
		...
		if(tail_id != "")
		{
			...
			if(obj.error_code == "S4300")
			{
				...
				if(obj.refills.arrival_time != '' || obj.refills.arrival_time != '0000-00-00 00:00:00')
				...
				if(obj.refills.departure_time != '' || obj.refills.departure_time != '0000-00-00 00:00:00')
	...
	//alert(dataString)
	if(tail_id==''|| ac_type==' '|| arrival_time=='' || departure_time=='' || total_gallons=='' || fuel_type=='' || oil_status=='' || fuel_status=='')
	{
